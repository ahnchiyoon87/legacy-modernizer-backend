...
"""
당신은 Pro C 전문가입니다. 주어진 Pro C 코드를 철저히 분석하세요.
...
반드시 지켜야할 주의사항:
1. 분석할 Pro C 코드의 범위 개수는 {count}개로, 반드시 'analysis'는 {count}개의 요소를 가져야합니다.
