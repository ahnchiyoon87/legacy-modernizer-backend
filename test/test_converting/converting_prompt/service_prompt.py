...
주어진 Stored Procedure Code를 기반으로 비즈니스 로직을 생성하는 작업을 맡았습니다.
...
def convert_code(convert_sp_code, service_code, variable_list, procedure_variables, context_range, count):
    ...
    result = chain.invoke({"code": convert_sp_code, "service": service_code, "variable": variable_list, "command_variables": procedure_variables_json, "context_range": context_range_json, "count": count})
    return result