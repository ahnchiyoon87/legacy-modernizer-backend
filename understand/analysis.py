...
STATEMENT_TYPES = ["SELECT", "INSERT", "ASSIGNMENT", "UPDATE", "DELETE", "EXECUTE_IMMDDIATE", "IF", "FOR", "COMMIT", "MERGE", "WHILE", "CALL", "DECLARE", "PROCEDURE", "FUNCTION", "RETURN", "EXCEPTION", "TRY"]
DML_TYPES = ["UPDATE", "INSERT", "DELETE", "MERGE"]
PROCEDURE_TYPES = ["PROCEDURE", "FUNCTION", "CREATE_PROCEDURE_BODY"]
NON_ANALYSIS_TYPES = ["CREATE_PROCEDURE_BODY", "ROOT", "PROCEDURE","FUNCTION", "DECLARE"]
